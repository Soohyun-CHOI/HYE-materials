...
is over again with no correction against it, the waiting bill names no delivery,
the waiting arrival has no invoice, and its order is unbilled — plus that no record
