...
// module exists for is unchanged: offline/authz-wrappers.mjs can import these
// factories, inject a refusing gate and exercise them with no credentials.
//
// THAT SENTENCE NAMED scripts/tests/verify-authz.mjs AS THE IMPORTER AND IT HAS
// NOT BEEN ONE SINCE #152, which moved the wrapper exercise into the offline
// tier; that file imports nothing from here now. Corrected in #196. The same
// correction applies to the paragraph above, which is #147's history and reads as
// current: the script it describes is offline/authz-wrappers.mjs.
//
