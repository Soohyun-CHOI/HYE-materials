...
// learns the Job on the telephone. It does NOT have the Discipline — that is #19's
 ...
 *
 * ORDER IS THE ORDER A READER FIXES THEM IN, not a precedence: the file is the
 * form's first section, the vendor is in the fields under it, and the Job is asked
 * for inside the modal. A reader told about the last one first would go looking
 * past two empty fields.
 *
...
export const DIRECT_PURCHASE_COPY = {
    ...
    blocked: {
        ...
        [DIRECT_PURCHASE_BLOCKED.noVendor]: "Pick the vendor on the form first.",
