...
export const STATUS_COPY = {
    ...
    column: {
         ...
         *
         * `Billed`, NOT `Invoiced`, and the difference is which side is speaking.
         * `Invoiced` is the figure this app computes and prints in a column head; the
         * chip states what the VENDOR has done, which is the same choice
         * `Awaiting invoice` already makes on the deliveries list. `Awaiting invoice`
         * is that list's exact word, reused rather than re-coined.
         */
        poInvoicing: {
            billed: () => ({ key: "billed", text: "Billed", tone: "complete" }),
            "partly-billed": () => ({
                key: "partly-billed",
                text: "Partly billed",
                tone: "partial",
