 ...
 * Using the within-order figure would report 2 as outstanding when it is standing
 * in the warehouse.
 *
...
export function lineStatus({ orderedQty, invoicedQty, deliveredWithinQty, deliveredOverQty } = {}) {
    ...
    return {
        ...
        // Contrast lib/poItemQty.js:remainingQty, which MUST stay signed because
 ...
 * different reasons.
 */
const INFERRED_REASON =
    "this ordered item carries more than one bill and the deliveries cannot be " +
