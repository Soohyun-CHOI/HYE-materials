        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                {/* #384 — ONE BLOCK, AND THE QUALIFIER WENT WITH THE SECOND ONE.
                    ...
                    Which address an order was placed to is #386's, which freezes it
                    onto the order instead of reading the job live. */}
 ...
 * file — Airtable's copy is the copy of record. That last step is scheduled
 * with after(), so this must be called from a request scope (both callers are
 * Server Actions).
...
export async function generateAndAttachPOPdf(poRecordId) {
    ...
    // resolves the job's default and the vendor's own and nothing else. The
