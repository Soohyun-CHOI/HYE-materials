...
// to lib/poItemQty.js, which is where a per-line quantity judgement belongs;
 ...
 *
 * `Signed` is the overwhelming majority of rows, so labelling it says nothing
 ...
 * fits one line.
 *
 * An unrecognised status is shown as `PO: <status>` rather than swallowed — a new
