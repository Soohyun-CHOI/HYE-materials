...
// written: `HYE-INV-260804-07` billed 13 against a shipment of 10 and paired.
//
 ...
 * bill. #232 deleted that export with the `This bill:` line it decided, so the
 * collision is gone. The name stays: it says plainly that the subject is two bills
 ...
 * while `HYE-INV-260804-05`, already recorded on that shipment, charged the same
