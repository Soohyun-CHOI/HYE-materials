...
function recordToPR(record) {
    return {
        ...
        // cost is already known at PR creation time. Grand Total is a
        // formula (Total Amount + Shipping Fee, blank treated as 0).
        shippingFee: record.get("Shipping Fee"),
        grandTotal: record.get("Grand Total"),
 ...
 * path, same enforcement style as PR Items' Rate (issue #69).
 */
