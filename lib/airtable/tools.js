...
/**
 * Every tool, for the list at `/tools` (#339).
 *
 ...
 * finding a tool's units costs no query of its own — the same saving
 ...
 * so the page is `2 + ceil(total tool items / 50)` operations — which passes ten
