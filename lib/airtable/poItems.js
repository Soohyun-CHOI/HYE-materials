...
function recordToPOItem(record) {
    return {
        ...
        // this ordered item, the reverse of Delivery Items."Original PO Item".
        ...
        //
        // NOT called `overageDeliveryItems`, and the parallel field on Purchase
        // Requests keeps that name on purpose: there it means "the rows this request
        // corrects" and here it would mean "the rows that left me". One name for two
        // meanings across two parents is worse than the accidental collisions #164
        // had to census, because it would be deliberate.
        reattachedDeliveryItems: record.get("Reattached Delivery Items") || [],
    };
}
