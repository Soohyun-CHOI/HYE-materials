...
function recordToDelivery(record) {
    return {
        ...
        // Issue #210 — the reverse of Invoices."Delivery": the bills that name this
        // arrival. PLURAL, and the asymmetry with the singular on the far side IS
        // the n:1 rule — a shipment can be billed in more than one document while a
        // bill is not split across shipments.
        //
        ...
        // `|| []` turns into "no invoice names this arrival" — so every delivery on
