 ...
 * compares, so two ordered items Airtable would consider the same material are the same
 ...
 * is the one cached) and `poItemIds` (EVERY ordered item for it, all of which get the
 * Material link). Two ordered items of one material in a PO are real — split
