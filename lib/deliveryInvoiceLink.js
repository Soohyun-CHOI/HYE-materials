...
export const LINK_COPY = {
    field: {
        ...
        label: () => ({
            key: "label",
            text: "The packing list shows an invoice number",
        }),
        /**
         * WHAT THE CONTROL IS FOR, said where it is (#231). It replaces the note
         * that used to explain why blank was a normal answer: blank is no longer an
         * answer at all, it is the unticked box, and what needs saying instead is
         * that a number read off the document beats what the app worked out.
         */
        transcribed: () => ({
            key: "transcribed",
            text:
                "Pick the number printed on the packing list, not the invoice you think this is. " +
                "It is taken as read from the document, so it is attached ahead of anything the " +
                "app worked out.",
        }),
