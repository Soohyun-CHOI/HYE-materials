...
// needs from `lib/poSend.js` rather than spelling it twice. That module is pure too,
// so both halves of this file stay safe for a browser bundle and for the offline
// tier; the extension is spelled out because that tier runs under plain `node` with
// no loader.
