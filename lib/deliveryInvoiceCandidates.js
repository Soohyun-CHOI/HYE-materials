...
export async function getInvoiceLinkCandidates(user, { vendorRecordIds } = {}) {
    ...
    for (const item of items) {
        ...
        // item anyway — and it is what lets the matcher ask how much of a shipment
        // a bill already on it has claimed. Not a quantity MATCH: see
...
export async function getArrivalsForBill(user, { vendorRecordId, orderedItems } = {}) {
    ...
    // are quantity that arrived. `qtyOnOrderedItem` sums them.
