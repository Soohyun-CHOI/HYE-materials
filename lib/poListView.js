...
//
// THIS LIVES ON `/pos` RATHER THAN `/prs`, WHICH IS THE OPPOSITE OF WHAT #176'S
// ISSUE BODY SAYS. Generation is Admin-only, Admin is office staff, and office
// staff work on `/pos`; putting it on the request list would show it mostly to
// people who cannot press the button. The requester's path to knowing is the PR
// detail page, whose copy #176 also corrects. The issue body's sentence reads
// "a missing PO cannot appear in a list of POs" — which is the argument for a
// strip rather than an argument against this page, since a strip is exactly what
// shows a list what the list cannot.
//
