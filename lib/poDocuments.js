...
// lib/invoiceItemFold.js's key at this scope — two charges at different
...
/**
 * The ordered items this order holds, by record id, so a charge or a delivery can
...
/**
 * One charge's fold key: the ordered item it charges, plus the unit price.
 *
...
export const PO_DOCUMENTS_COPY = {
    invoices: {
        ...
        /**
         * One charge: what this invoice invoiced against one of this order's items.
         *
