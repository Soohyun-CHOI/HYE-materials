 ...
 * may be given: the invoice is not changed and the ordered items will read as
 * invoiced with nothing delivered. Nothing becomes uncomputable — the escalation
 * simply stops one step earlier, and it also stops one read earlier, since the
 * invoices behind the ordered items are then never fetched.
 *
 ...
 * leaves the ordered item reading as MORE delivered than arrived, which #169 records as
