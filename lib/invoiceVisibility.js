 ...
 * places ask — this module's own `getVisibleInvoiceIds`, the invoice list's
 * `Invoice Items` fetch, and `checkInvoicePairing`'s read and guard — and every one
 * of them is about COST rather than about disclosure. It also decided whether the
