...
export function planDelivery({ lines, vendorRecordId, materialRecordId, poRecordId = null, qty }) {
    ...
    // behaviour of its own and the check can pin it. Not `blocked`: there is
...
// makes a reader ask what the difference is, and there is none. Airtable's own
// `Over Delivery` field name is untouched — it is outside this repo, and renaming
// it would break a lookup rather than fix a word.
...
export const ALLOCATION_COPY = {
    preview: {
        ...
        /**
         * Nothing outstanding at all — the fourth state (#162 review). Now says
