 ...
 *
 * NO ITEMS, NO LINE AND NO SIGNERS, and none of the three is an omission. The
 * items are what only the site knows; the Line is the value this whole table
...
export async function claimDirectPurchase({ user, directPurchase }) {
    const pr = await createPR({
        ...
        // reaches its Job through `Line`, which is what the requester picks next.
        lineId: null,
