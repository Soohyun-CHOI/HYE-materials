 ...
 */
export const NAME_PATH = "/login/name";
 ...
 *
 * IN A CONSTANT RATHER THAN IN JSX because `scripts/screen-strings.mjs` cannot
 * see a string written into an element, and a word no tool can find is a word no
 * vocabulary sweep can keep in step.
 *
