...
/**
 * HYE-PO-YYMMDD-## — the same stamp every other family writes since #313. It was
 * `YYYYMMDD` to match the company's own pre-app purchase order numbers; why that
 * observation is true and why it was not a constraint is in lib/idSequence.js,
 * beside the registry that no longer carries a width at all.
 */
