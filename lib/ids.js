 ...
 * `CHILD_KINDS` in lib/idSequence.js, keyed on the link field name, so
 * "a Quotation is {PR ID}-Q##" is stated once instead of at one of eight call
 * sites. An unregistered link field throws rather than defaulting.
 *
...
export async function generateChildId(
    ...
    const kind = childKind(parentLinkFieldName);
