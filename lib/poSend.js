...
// THE OTHER THREE. Those three write their HTML inline, where
...
// than merely readable. The remaining three are not moved: their wording is their own
// issues' and neither of these rewrote them.
//
 ...
 *
 * THE TOTAL IS FORMATTED BY THE CALLER, like `SEND_COPY.mail`'s. It arrives as a
 * string, so this builder does no arithmetic and no formatting — and #233's rule that
 * money goes through `formatUSD` reaches the mail rather than stopping at the screen.
 */
